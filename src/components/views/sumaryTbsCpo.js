...
import TableSummaryTbsCpo from '../../utilities/tableSummaryTBSCPO';
...
return (
    <div className="container">
      ...
      >
        ...
        >
          <Button style={{ marginLeft: "10px" }} onClick={() => history.push('/inputDmo')} color="warning">
