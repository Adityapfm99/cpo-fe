...
const ProductionGroupReport = () => {
  return (
    <div className="container">
      <div className="row">
        <div className="col-12">
          <h1 style={{ marginTop: "2rem" }}>Group Production Report</h1>
        </div>
      </div>
      <hr></hr>
      <div
      ...
      <Label for="data"><i>*Dalam ribu metrik ton</i></Label>
...
export default ProductionGroupReport;
