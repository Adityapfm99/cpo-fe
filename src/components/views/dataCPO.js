...
import TableDataCpo from '../../utilities/tableDataCpo';
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h1 style={{ marginTop: "2rem"  }}>Submit CPO</h1>
                    </div>
                </div>
                <div className="row" style={{ display: "flex", flexDirection: "row", justifyConten: "space-evenly" }}>
                    ...
                    <div className="col">
                        <Button color="primary-button" onClick={() => history.push('/inputDailyReport')} style={{ color: "white" }}>
                            <span style={{ margin: "10px" }}>Add CPO</span> 
